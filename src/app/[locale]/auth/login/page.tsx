      ...
      >
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-semibold text-gray-700">{t('auth.continueWithGoogle')}</span>
          </button>
          ...
          <form onSubmit={handleEmailSubmit} className="space-y-3">
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 text-sm text-gray-800 placeholder:text-gray-400 focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all"
              />
            </div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                minLength={6}
                className="w-full pl-10 pr-10 py-3 rounded-xl border border-gray-200 text-sm text-gray-800 placeholder:text-gray-400 focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all"
              />
              <button
                type="button"
